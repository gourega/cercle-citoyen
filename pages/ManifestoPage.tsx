  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <article className="max-w-4xl mx-auto px-6 pt-20 pb-10">
        ...
        <section 
          ref={sectionRef}
          className={`bg-gray-900 text-white p-12 md:p-20 rounded-[4rem] text-center shadow-2xl relative overflow-hidden transition-all duration-1000 transform mb-24 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
        >
